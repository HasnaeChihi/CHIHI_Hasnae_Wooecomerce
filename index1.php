...
$woocommerce = new Client(
    ...
    'ck_4b3a415faf09875d37f494e47d0fc7f1f38ebb9a',
    'cs_3e26959bb36e65eb2d8be82b7d8320cd3c3cc662',
    [
        'wp_api' => true,
        'version' => 'wc/v3',
...
try {
    ...
    //you can set any date which you want
               $query = ['date_min' => '2022-01-01', 'date_max' => '2022-12-30'];
  /*  $sales = $woocommerce->get('reports/sales', $query);
    ...
    if (isset($_POST['btn-update'])) {
        ...
        header('Location: http://localhost/CHIHI_Hasnae_Wooecomerce');
        }
